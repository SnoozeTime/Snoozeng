...
impl Button {
    pub fn new(text: String, position: Vector2f) -> Self {
        Self {
            text,
            dimensions: None,
            anchor: position,
    ...
    pub fn dimensions(mut self, dim: Vector2f) -> Self {
    ...
    pub fn build(self, ui: &mut Gui) -> bool {
        ...
        let mouse_pos_rel = &ui.mouse_pos - self.anchor.clone();
